...
We measured the amount and type of reef corals that lived during two time intervals. The earlier time interval is when the _fossil corals_ (the nick name we use for short) lived and spans from approximately 6 000 to 8 000 years ago (xxxcheck). And the latter time interval is when _subrecent corals_ (another nickname) lived and and spans from 2014 (xxx), when we collected the most recent samples, back in time to a few years decades, depending on how fast each reef grows. The data we have lets us compare quantitatively how reefs changed since substantial human impact begun. In short, we are time-travellers (Isn't that exciting?) and we would like to share our findings with you!
...
xxxnext  This finding is really cool, we need to find out exactly what is the difference (the details) between reefs and time intervals....We`ll keep you posted



As we work towards out main goal, a number of other good things happened that I would like to share with your. ....
